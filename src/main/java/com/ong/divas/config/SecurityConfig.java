    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/localidades", "/localidades/**").hasAnyAuthority("administrador", "beneficiaria")
                .requestMatchers(HttpMethod.DELETE, "/localidades", "/localidades/**").hasAnyAuthority("administrador", "beneficiaria")
